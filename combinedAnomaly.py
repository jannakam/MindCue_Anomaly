        ...
        while True:
            try:
                ...
                if len(updated_data) > 10:
                    ...
                    model_IF = train_model(updated_data[['BPM', 'GSR', 'C3', 'C4', 'F1', 'F2']])
                else:
                    model_IF = train_model(updated_data[['BPM', 'GSR', 'C3', 'C4', 'F1', 'F2']])
                ...
                anomaly_score = model_IF.decision_function(latest_row[['BPM', 'GSR', 'C3', 'C4', 'F1', 'F2']])
                is_anomaly = model_IF.predict(latest_row[['BPM', 'GSR', 'C3', 'C4', 'F1', 'F2']])
